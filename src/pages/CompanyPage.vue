...
export default {
  ...
  methods: {
    ...
    async loadMore() {
      ...
      await axios
        .get(
          `https://api.themoviedb.org/3/discover/movie?api_key=a0620608f8e0ad4da9adb563a7f5a2d5&language=en-US&sort_by=${this.sortQuery}&with_companies=${this.$route.params.id}&vote_count.gte=100&with_watch_monetization_types=free`,
          {
            params: {
              page: this.page,
            },
